...
from verifact.api.schemas import RFC7807ProblemDetails
...
def setup_error_handlers(app: FastAPI) -> None:
    ...
    async def validation_exception_handler(
        ...
        problem = RFC7807ProblemDetails(
            type="https://verifact.org/errors/validation-error",
    ...
    async def verifact_exception_handler(request: Request, exc: VeriFactException) -> JSONResponse:
        ...
        error_type = f"https://verifact.org/errors/{exc.error_code.lower().replace('_', '-')}"
    ...
    async def general_exception_handler(request: Request, exc: Exception) -> JSONResponse:
        ...
        problem = RFC7807ProblemDetails(
            type="https://verifact.org/errors/internal-error",
