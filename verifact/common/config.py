...
class Settings(BaseSettings):
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://verifact:verifact_secret@localhost:5432/verifact_db",
    ...
    # Search Provider Keys (Read with or without VERIFACT_ prefix)
