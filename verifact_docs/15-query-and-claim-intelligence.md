# VeriFact — Query and Claim Intelligence

## 1. Purpose

Claim and Query Intelligence is the front end of the VeriFact verification pipeline.
...
> **Before VeriFact asks whether something is true, it must first establish what exactly is being asserted.**
...
- regression testing;
- error taxonomy;
- and the metrics required to prove that VeriFact is actually improving rather than merely becoming more complex.
