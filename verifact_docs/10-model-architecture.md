# VeriFact — Model Architecture

## 1. Purpose

This document translates the VeriFact methodology into a concrete machine-learning architecture.
...
VeriFact should not depend on one "fact-checking model."
...
VeriFact needs verification-specific evaluation.
...
This principle is central to building VeriFact for millions of users.
