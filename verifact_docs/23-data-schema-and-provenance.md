# VeriFact — Data Schema, Storage, and Provenance Graph Specification

## 1. Purpose & Persistence Architecture

VeriFact requires a persistent, auditable data store capable of satisfying two distinct workloads:
