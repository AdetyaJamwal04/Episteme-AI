# VeriFact — Retrieval Architecture

## 1. Purpose

Retrieval is the most important information-access layer in VeriFact.
...
A high-quality VeriFact retrieval system should not return the largest pile of sources.
