# VeriFact — Problem Definition

## 1. Problem Statement

Given a natural-language factual claim, VeriFact must determine the state of available evidence surrounding that claim.
...
The canonical taxonomies are formally defined in [00-canonical-enums.md](file:///c:/Projects/VeriFact/verifact_docs/00-canonical-enums.md).
...
VeriFact must simultaneously optimize:
