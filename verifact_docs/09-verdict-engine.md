# VeriFact — Verdict Engine

## 1. Purpose

This document defines the final decision layer of VeriFact.
...
The canonical internal verdict taxonomy is defined in [00-canonical-enums.md](file:///c:/Projects/VeriFact/verifact_docs/00-canonical-enums.md):
...
A mature VeriFact system should therefore be comfortable saying:
