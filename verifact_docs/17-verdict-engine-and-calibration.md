# VeriFact — Verdict Engine and Calibration

## 1. Purpose

The Verdict Engine is the decision layer of VeriFact.
...
Canonical internal and public taxonomies are defined in [00-canonical-enums.md](file:///c:/Projects/VeriFact/verifact_docs/00-canonical-enums.md).
...
The goal is not to make VeriFact sound certain.
