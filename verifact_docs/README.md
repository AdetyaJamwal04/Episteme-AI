# VeriFact — Architecture and Engineering Documentation

Welcome to the comprehensive architecture and design specification for **VeriFact**, an evidence-grounded claim verification platform designed for automated, calibrated, and auditable fact verification.
...
VeriFact enforces a strict, multi-stage pipeline where raw text is converted into structured evidence before reaching a final verdict:
...
Across all documents, VeriFact maintains these non-negotiable principles:
