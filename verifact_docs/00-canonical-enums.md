# VeriFact — Canonical Enums and Taxonomies

## 1. Purpose

This document is the **single source of truth** for all enums, taxonomies, and categorical values used across the VeriFact system.
