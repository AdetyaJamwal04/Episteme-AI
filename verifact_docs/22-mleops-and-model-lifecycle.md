# VeriFact — MLOps and Model Lifecycle Engineering Specification

## 1. Purpose & Core Philosophy

VeriFact relies on a hybrid hierarchy of machine learning models:
...
A model candidate must automatically satisfy the following threshold gates on the **VeriFact Evaluation Suite ($N=250+$)** before staging or canary deployment:
...
VeriFact continuously computes drift metrics over a rolling 7-day window:
